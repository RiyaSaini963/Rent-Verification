<%-- 
    Document   : after_form
    Created on : 3 May, 2019, 12:01:40 PM
    Author     : Riya
--%>
...
<div class="bg-text">Your application is under process for authentication.
    Your application number is<input type="text" name="id" value="${id}" disabled=""> Kindly provide this to Landlord.</div><br>
