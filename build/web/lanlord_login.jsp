<%-- 
    Document   : lanlord_login
    Created on : 5 May, 2019, 12:20:22 AM
    Author     : Riya
--%>
...
<div class="bg-img">
  <form method="post" action="l_login" class="container">
    ...
    <input type="text" placeholder="Enter Email Id" name="phn" required>
