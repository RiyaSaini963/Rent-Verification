<%-- 
    Document   : tenant_signup
    Created on : 4 May, 2019, 11:20:21 AM
    Author     : Riya
--%>
...
<form method="post" action="tlogin">
  <div class="container">
    ...
    <hr>
    <p>By creating an account you agree to our <a href="tenant_login">Terms & Privacy</a>.</p>

    <button type="submit" class="registerbtn">Register</button>
  </div>
  
  <div class="container signin">
    <p>Already have an account? <a href="tenant_login">Sign in</a>.</p>
  </div>
</form>
